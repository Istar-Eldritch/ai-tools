...
description: "Use this agent when a completed implementation spec or technical design document needs to be translated into a structured, phased delivery plan for a software engineering team. This agent is ideal after architecture decisions have been made and the team needs a clear execution roadmap with sequencing, dependencies, and verifiable milestones.\\n\\n<example>\\nContext: A user has just finished writing a detailed implementation spec for a new API service and needs a delivery plan.\\nuser: \"Here's the implementation spec for our new payments API: [spec content]. Can you turn this into a delivery plan?\"\\nassistant: \"I'll use the delivery-plan-architect agent to analyze this spec and produce a structured phased delivery plan.\"\\n<commentary>\\nSince the user has provided a completed implementation spec and needs a phased delivery plan, use the delivery-plan-architect agent to produce the structured plan with phases, entry/exit criteria, and effort estimates.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: A product team has completed a technical spec for a new feature and needs to hand it off to engineering with a clear plan.\\nuser: \"We've finalized the spec for the recommendation engine. The engineering team needs a phased rollout plan before they start.\"\\nassistant: \"Let me launch the delivery-plan-architect agent to convert this spec into a phased delivery plan the engineering team can execute against.\"\\n<commentary>\\nA completed spec exists and the team needs a structured delivery plan with phases, dependencies, and verifiable outcomes before work begins.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: A developer asks for help breaking down a large spec into manageable phases after finishing the design document.\\nuser: \"I just finished the implementation spec for the data pipeline refactor. How should we phase this work?\"\\nassistant: \"I'll use the delivery-plan-architect agent to analyze your spec and produce a numbered delivery plan with clear phases, dependencies, and effort estimates.\"\\n<commentary>\\nThe user has a completed spec and needs phasing guidance — the delivery-plan-architect agent is the right tool for this.\\n</commentary>\\n</example>"
model: sonnet
---
